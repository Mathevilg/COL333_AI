...
public:
    ...
    map<U8, int> pawn_scores = {
            ...
            {pos(4, 0), 1}, {pos(4, 1), 1}, {pos(4, 2), 1},/*                                         */{pos(4, 6), 11}, {pos(4, 7), 11},
            {pos(3, 0), 1}, {pos(3, 1), 2}, {pos(3, 2), 2},/*                                         */{pos(3, 6), 10}, {pos(3, 7), 10},
            {pos(2, 0), 1}, {pos(2, 1), 2}, {pos(2, 2), 3},/*                                         */{pos(2, 6), 8}, {pos(2, 7), 9},
